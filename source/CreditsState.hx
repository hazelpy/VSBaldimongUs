...
class CreditsState extends MusicBeatState
{
	...
	private static var creditsStuff:Array<Dynamic> = [ //Name - Icon name - Description - Link - BG Color
		['VS Baldimong Us Team'],
		['Hazelpy (Rushtoxin)', 'hazelpy', 			'Everything except the stages.', 					'https://www.youtube.com/c/Rushtoxin',  0xFFBB33FF],
		['CosmicFroggo', 		'cosmicfroggo', 	'Stage artist and good friend.', 				 'https://gamebanana.com/members/1973175',  0xFFE91C33],
		['Psych Engine Team'],
